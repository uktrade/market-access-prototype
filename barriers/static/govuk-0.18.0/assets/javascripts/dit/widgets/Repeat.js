define(['modules/helpers'], function(helpers) {
	...
	function buildBlock(block) {
		var self = this;
		var container = $('<div class="repeat-block"><div class="inner"><button class="button pull-right btn-remove" type="button">Remove</button></div></div>');
		_.each(block, function(el) { 
			container.find('.inner').prepend(el);
		})
